  ...
  <div class="viewport ">
    <div class="overview collapse">
      ...
      <ul id="sidebar_menu" class="navbar nav nav-list container full">
        <li class="accordion-group active color_4"> <a class="dashboard " href="<?php echo url_for('@homepage')?>"><img src="img/menu_icons/dashboard.png"><span>Dashboard</span></a> </li>
        ...
        <ul class="nav nav_menu">
          <li class="dropdown"> <a class="dropdown-toggle administrator" id="dLabel" role="button" data-toggle="dropdown" data-target="#" href="/page.html">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
              <li><a href="html/profile.html"><i class=" icon-user"></i> My Profile</a></li>
