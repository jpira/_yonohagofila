CREATE TABLE alarma (id INT AUTO_INCREMENT, local_id INT, id_usuario INT NOT NULL, descripcion VARCHAR(255) NOT NULL, fecha_creacion DATETIME NOT NULL, slug TEXT NOT NULL, INDEX local_id_idx (local_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE calendario (id INT AUTO_INCREMENT, local_id INT, fecha_evento DATETIME NOT NULL, tipo_evento VARCHAR(50) NOT NULL, descripcion_evento VARCHAR(255) NOT NULL, fecha_creacion DATETIME NOT NULL, id_usuario INT NOT NULL, slug TEXT NOT NULL, fecha_actualizacion DATETIME NOT NULL, INDEX local_id_idx (local_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE credencial (id INT AUTO_INCREMENT, nombre VARCHAR(100) NOT NULL, id_usuario INT NOT NULL, fecha_creacion DATETIME NOT NULL, fecha_actualizacion DATETIME NOT NULL, slug VARCHAR(110) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE local (id INT AUTO_INCREMENT, nombre VARCHAR(200) NOT NULL, id_usuario INT NOT NULL, fecha_creacion DATETIME NOT NULL, slug VARCHAR(210) NOT NULL, fecha_actualizacion DATETIME NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE parametro (id INT AUTO_INCREMENT, local_id INT, descripcion VARCHAR(255) NOT NULL, imagen VARCHAR(255), numero_personas INT NOT NULL, promedio_consumo VARCHAR(50) NOT NULL, tiempo_respuesta VARCHAR(50) NOT NULL, horario_atencion VARCHAR(50), costo_ingreso VARCHAR(50) NOT NULL, fecha_creacion DATETIME NOT NULL, fecha_actualizacion DATETIME NOT NULL, id_usuario INT NOT NULL, slug TEXT NOT NULL, INDEX local_id_idx (local_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE perfil (id INT AUTO_INCREMENT, nombre VARCHAR(100) NOT NULL, id_usuario INT NOT NULL, fecha_creacion DATETIME NOT NULL, fecha_actualizacion DATETIME NOT NULL, slug VARCHAR(110) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE ranking (id INT AUTO_INCREMENT, nombre VARCHAR(100) NOT NULL, fecha_creacion DATETIME NOT NULL, id_usuario INT NOT NULL, slug VARCHAR(110) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
