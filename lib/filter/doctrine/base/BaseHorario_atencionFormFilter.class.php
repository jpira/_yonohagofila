...
/**
 * Horario_atencion filter form base class.
 *
 ...
 */
abstract class BaseHorario_atencionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('horario_atencion_filters[%s]');
