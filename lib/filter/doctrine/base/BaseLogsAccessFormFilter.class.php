...
/**
 * LogsAccess filter form base class.
 *
 ...
 */
abstract class BaseLogsAccessFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('logs_access_filters[%s]');
